...
def gen_module_caller(module_name, funcs, dependent_struct, dependent_enum, enum):
    ...
    cb_code_constructor = "        public " + module_name + "_rsp_cb(common.Modulemanager modules)\n"
    cb_code_constructor += "        {\n"
    cb_code_section = ""

    code = "    public class " + module_name + "_caller {\n"
    code += "        public static " + module_name + "_rsp_cb rsp_cb_" + module_name + "_handle = null;\n"
    code += "        private ThreadLocal<" + module_name + "_hubproxy> _hubproxy;\n"
    code += "        public client.Client _client_handle;\n"
    code += "        public " + module_name + "_caller(client.Client client_handle_) \n"
    code += "        {\n"
    ...
    code += "            }\n\n"
    code += "            _hubproxy = new ThreadLocal<" + module_name + "_hubproxy>();\n"
    code += "        }\n\n"
    ...
    code += "            if (_hubproxy.Value == null)\n{\n"
    code += "                _hubproxy.Value = new " + module_name + "_hubproxy(_client_handle, rsp_cb_" + module_name + "_handle);\n"
    code += "            }\n"
    code += "            _hubproxy.Value.hub_name_" + _hub_uuid + " = hub_name;\n"
    code += "            return _hubproxy.Value;\n"
    code += "        }\n\n"
    code += "    }\n\n"
        ...
        if i[1] == "ntf":
            ...
            for _type, _name, _parameter in i[2]:
                ...
                if type_ in tools.OriginalTypeList:
                    ...
                    if array_type_ == tools.TypeType.Enum:
            ...
            code += "            _client_handle.call_hub(hub_name_" + _hub_uuid + ", \"" + module_name + "_" + func_name + "\", _argv_" + _argv_uuid + ");\n"
            code += "        }\n\n"
            ...
            cb_code_constructor += "            modules.add_mothed(\"" + module_name + "_rsp_cb_" + func_name + "_rsp\", " + func_name + "_rsp);\n"
            cb_code_constructor += "            modules.add_mothed(\"" + module_name + "_rsp_cb_" + func_name + "_err\", " + func_name + "_err);\n"
