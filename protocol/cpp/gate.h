...
/*this cb code is codegen by abelkhan for cpp*/
    ...
    class hub_call_gate_rsp_cb;
    class hub_call_gate_reg_hub_direct_cb : public std::enable_shared_from_this<hub_call_gate_reg_hub_direct_cb>{
    private:
        uint64_t cb_uuid;
        std::shared_ptr<hub_call_gate_rsp_cb> module_rsp_cb;

    public:
        hub_call_gate_reg_hub_direct_cb(uint64_t _cb_uuid, std::shared_ptr<hub_call_gate_rsp_cb> _module_rsp_cb);
    public:
        concurrent::signals<void()> sig_reg_hub_direct_cb;
        concurrent::signals<void()> sig_reg_hub_direct_err;
        concurrent::signals<void()> sig_reg_hub_direct_timeout;

        std::shared_ptr<hub_call_gate_reg_hub_direct_cb> callBack(std::function<void()> cb, std::function<void()> err);
        void timeout(uint64_t tick, std::function<void()> timeout_cb);
    };
...
/*this cb code is codegen by abelkhan for cpp*/
    ...
    public:
        ...
        std::mutex mutex_map_reg_hub_direct;
        std::unordered_map<uint64_t, std::shared_ptr<hub_call_gate_reg_hub_direct_cb> > map_reg_hub_direct;
        ...
        void Init(std::shared_ptr<modulemng> modules){
            ...
            modules->reg_method("hub_call_gate_rsp_cb_reg_hub_direct_rsp", std::make_tuple(shared_from_this(), std::bind(&hub_call_gate_rsp_cb::reg_hub_direct_rsp, this, std::placeholders::_1)));
            modules->reg_method("hub_call_gate_rsp_cb_reg_hub_direct_err", std::make_tuple(shared_from_this(), std::bind(&hub_call_gate_rsp_cb::reg_hub_direct_err, this, std::placeholders::_1)));
        ...
        void reg_hub_direct_rsp(const msgpack11::MsgPack::array& inArray){
            auto uuid = inArray[0].uint64_value();
            auto rsp = try_get_and_del_reg_hub_direct_cb(uuid);
            if (rsp != nullptr){
                rsp->sig_reg_hub_direct_cb.emit();
            }
        }

        void reg_hub_direct_err(const msgpack11::MsgPack::array& inArray){
            auto uuid = inArray[0].uint64_value();
            auto rsp = try_get_and_del_reg_hub_direct_cb(uuid);
            if (rsp != nullptr){
                rsp->sig_reg_hub_direct_err.emit();
            }
        }

        void reg_hub_direct_timeout(uint64_t cb_uuid){
            auto rsp = try_get_and_del_reg_hub_direct_cb(cb_uuid);
            if (rsp != nullptr){
                rsp->sig_reg_hub_direct_timeout.emit();
            }
        }

        std::shared_ptr<hub_call_gate_reg_hub_direct_cb> try_get_and_del_reg_hub_direct_cb(uint64_t uuid){
            std::lock_guard<std::mutex> l(mutex_map_reg_hub_direct);
            if (map_reg_hub_direct.find(uuid) != map_reg_hub_direct.end()) {
                auto rsp = map_reg_hub_direct[uuid];
                map_reg_hub_direct.erase(uuid);
                return rsp;
            }
            return nullptr;
        }
    ...
    public:
        ...
        std::shared_ptr<hub_call_gate_reg_hub_direct_cb> reg_hub_direct(std::string hub_name, std::string hub_type){
            auto uuid_9e554add_7c96_571a_acbd_5c30f34b5474 = uuid_9796175c_1119_3833_bf31_5ee139b40edc++;
            msgpack11::MsgPack::array _argv_7bc49b0e_5316_38ca_91dd_81ddc3d405aa;
            _argv_7bc49b0e_5316_38ca_91dd_81ddc3d405aa.push_back(uuid_9e554add_7c96_571a_acbd_5c30f34b5474);
            _argv_7bc49b0e_5316_38ca_91dd_81ddc3d405aa.push_back(hub_name);
            _argv_7bc49b0e_5316_38ca_91dd_81ddc3d405aa.push_back(hub_type);
            call_module_method("hub_call_gate_reg_hub_direct", _argv_7bc49b0e_5316_38ca_91dd_81ddc3d405aa);

            auto cb_reg_hub_direct_obj = std::make_shared<hub_call_gate_reg_hub_direct_cb>(uuid_9e554add_7c96_571a_acbd_5c30f34b5474, rsp_cb_hub_call_gate_handle);
            std::lock_guard<std::mutex> l(rsp_cb_hub_call_gate_handle->mutex_map_reg_hub_direct);
            rsp_cb_hub_call_gate_handle->map_reg_hub_direct.insert(std::make_pair(uuid_9e554add_7c96_571a_acbd_5c30f34b5474, cb_reg_hub_direct_obj));
...
/*this module code is codegen by abelkhan codegen for cpp*/
    ...
    class hub_call_gate_reg_hub_direct_rsp : public Response {
    private:
        uint64_t uuid_7bc49b0e_5316_38ca_91dd_81ddc3d405aa;

    public:
        hub_call_gate_reg_hub_direct_rsp(std::shared_ptr<Ichannel> _ch, uint64_t _uuid) : Response("hub_call_gate_rsp_cb", _ch)
        {
            uuid_7bc49b0e_5316_38ca_91dd_81ddc3d405aa = _uuid;
        }

        void rsp(){
            msgpack11::MsgPack::array _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7;
            _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7.push_back(uuid_7bc49b0e_5316_38ca_91dd_81ddc3d405aa);
            call_module_method("hub_call_gate_rsp_cb_reg_hub_direct_rsp", _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7);
        }

        void err(){
            msgpack11::MsgPack::array _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7;
            _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7.push_back(uuid_7bc49b0e_5316_38ca_91dd_81ddc3d405aa);
            call_module_method("hub_call_gate_rsp_cb_reg_hub_direct_err", _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7);
        }
    ...
    public:
        ...
        void Init(std::shared_ptr<modulemng> _modules){
            ...
            _modules->reg_method("hub_call_gate_reg_hub_direct", std::make_tuple(shared_from_this(), std::bind(&hub_call_gate_module::reg_hub_direct, this, std::placeholders::_1)));
        ...
        concurrent::signals<void(std::string, std::string)> sig_reg_hub_direct;
        void reg_hub_direct(const msgpack11::MsgPack::array& inArray){
            auto _cb_uuid = inArray[0].uint64_value();
            auto _hub_name = inArray[1].string_value();
            auto _hub_type = inArray[2].string_value();
            rsp = std::make_shared<hub_call_gate_reg_hub_direct_rsp>(current_ch, _cb_uuid);
            sig_reg_hub_direct.emit(_hub_name, _hub_type);
            rsp = nullptr;
        }
