...
/*this caller code is codegen by abelkhan codegen for cpp*/
    ...
    public:
        ...
        std::shared_ptr<center_reg_server_cb> callBack(std::function<void(uint32_t serial_num, std::string sub_name)> cb, std::function<void()> err);
...
/*this cb code is codegen by abelkhan for cpp*/
    ...
    public:
        ...
        void reg_server_rsp(const msgpack11::MsgPack::array& inArray){
            ...
            auto _sub_name = inArray[2].string_value();
            auto rsp = try_get_and_del_reg_server_cb(uuid);
            if (rsp != nullptr){
                rsp->sig_reg_server_cb.emit(_serial_num, _sub_name);
            }
        }
    ...
    public:
        ...
        std::shared_ptr<center_reg_server_cb> reg_server(std::string type, std::string sub_type, std::string host, uint16_t port){
...
/*this module code is codegen by abelkhan codegen for cpp*/
    ...
    public:
        ...
        void rsp(uint32_t serial_num, std::string sub_name){
            ...
            _argv_86ab8166_c1a7_3809_8c9b_df444f746076.push_back(sub_name);
    ...
    public:
        ...
        void reg_server(const msgpack11::MsgPack::array& inArray){
            ...
            sig_reg_server.emit(_type, _sub_type, _host, _port);
            rsp = nullptr;
        }
