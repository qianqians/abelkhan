...
export class client_call_gate_rsp_cb extends abelkhan.Imodule {
    ...
    public get_hub_info_rsp(inArray:any[]){
        ...
        _argv_64f76bda_d44d_3aed_a6a4_d85fea361e24.push(protcol_to_hub_info(inArray[1]));
...
export class hub_call_gate_reg_hub_direct_cb{
    private cb_uuid : number;
    private module_rsp_cb : hub_call_gate_rsp_cb;
...
export class hub_call_gate_reverse_reg_client_hub_cb{
    private cb_uuid : number;
    private module_rsp_cb : hub_call_gate_rsp_cb;

    public event_reverse_reg_client_hub_handle_cb : ()=>void | null;
    public event_reverse_reg_client_hub_handle_err : (err:framework_error.framework_error)=>void | null;
...
export class hub_call_gate_rsp_cb extends abelkhan.Imodule {
    ...
    public map_reg_hub_direct:Map<number, hub_call_gate_reg_hub_direct_cb>;
    public map_reverse_reg_client_hub:Map<number, hub_call_gate_reverse_reg_client_hub_cb>;
    constructor(modules:abelkhan.modulemng){
        ...
        this.map_reg_hub_direct = new Map<number, hub_call_gate_reg_hub_direct_cb>();
        modules.reg_method("hub_call_gate_rsp_cb_reg_hub_direct_rsp", [this, this.reg_hub_direct_rsp.bind(this)]);
        modules.reg_method("hub_call_gate_rsp_cb_reg_hub_direct_err", [this, this.reg_hub_direct_err.bind(this)]);
        this.map_reverse_reg_client_hub = new Map<number, hub_call_gate_reverse_reg_client_hub_cb>();
    ...
    public reverse_reg_client_hub_rsp(inArray:any[]){
        let uuid = inArray[0];
        let _argv_03d844bd_f79a_3179_8f8b_9f0ed380f60c:any[] = [];
    ...
    public reverse_reg_client_hub_err(inArray:any[]){
        let uuid = inArray[0];
        let _argv_03d844bd_f79a_3179_8f8b_9f0ed380f60c:any[] = [];
    ...
    public reverse_reg_client_hub_timeout(cb_uuid : number){
    ...
    private try_get_and_del_reverse_reg_client_hub_cb(uuid : number){
...
export class hub_call_gate_caller extends abelkhan.Icaller {
    ...
    public reg_hub_direct(hub_name:string, hub_type:string){
        let uuid_9e554add_7c96_571a_acbd_5c30f34b5474 = Math.round(this.uuid_9796175c_1119_3833_bf31_5ee139b40edc++);
        ...
        this.call_module_method("hub_call_gate_reg_hub_direct", _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7);

        let cb_reg_hub_direct_obj = new hub_call_gate_reg_hub_direct_cb(uuid_9e554add_7c96_571a_acbd_5c30f34b5474, rsp_cb_hub_call_gate_handle);
        if (rsp_cb_hub_call_gate_handle){
            rsp_cb_hub_call_gate_handle.map_reg_hub_direct.set(uuid_9e554add_7c96_571a_acbd_5c30f34b5474, cb_reg_hub_direct_obj);
        }
        return cb_reg_hub_direct_obj;
    }

    public tick_hub_health(tick_time:number){
        let _argv_e81472b5_19a4_36bc_9cd9_b8fe87a10079:any[] = [];
        _argv_e81472b5_19a4_36bc_9cd9_b8fe87a10079.push(tick_time);
        this.call_module_method("hub_call_gate_tick_hub_health", _argv_e81472b5_19a4_36bc_9cd9_b8fe87a10079);
    }

    public reverse_reg_client_hub(client_uuid:string){
        let uuid_5352b179_7aef_5875_a08f_06381972529f = Math.round(this.uuid_9796175c_1119_3833_bf31_5ee139b40edc++);

        let _argv_03d844bd_f79a_3179_8f8b_9f0ed380f60c:any[] = [uuid_5352b179_7aef_5875_a08f_06381972529f];
        ...
        let cb_reverse_reg_client_hub_obj = new hub_call_gate_reverse_reg_client_hub_cb(uuid_5352b179_7aef_5875_a08f_06381972529f, rsp_cb_hub_call_gate_handle);
        if (rsp_cb_hub_call_gate_handle){
...
export class client_call_gate_get_hub_info_rsp extends abelkhan.Icaller {
    ...
    public rsp(hub_info:hub_info){
        ...
        _argv_64f76bda_d44d_3aed_a6a4_d85fea361e24.push(hub_info_to_protcol(hub_info));
...
export class hub_call_gate_reg_hub_direct_rsp extends abelkhan.Icaller {
    ...
    public rsp(){
        ...
        this.call_module_method("hub_call_gate_rsp_cb_reg_hub_direct_rsp", _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7);
    }

    public err(){
        let _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7:any[] = [this.uuid_7bc49b0e_5316_38ca_91dd_81ddc3d405aa];
        this.call_module_method("hub_call_gate_rsp_cb_reg_hub_direct_err", _argv_2dd51db8_e47e_346d_bdd6_6c41856647a7);
    }

}

export class hub_call_gate_reverse_reg_client_hub_rsp extends abelkhan.Icaller {
    private uuid_ef84ff12_6e4a_39cd_896e_27f3ac82fa1a : number;
    constructor(_ch:abelkhan.Ichannel, _uuid:number){
        super("hub_call_gate_rsp_cb", _ch);
...
export class hub_call_gate_module extends abelkhan.Imodule {
    ...
    constructor(modules:abelkhan.modulemng){
        ...
        this.modules.reg_method("hub_call_gate_reg_hub_direct", [this, this.reg_hub_direct.bind(this)]);
        this.modules.reg_method("hub_call_gate_tick_hub_health", [this, this.tick_hub_health.bind(this)]);
    ...
    reg_hub_direct(inArray:any[]){
        ...
        _argv_.push(inArray[1]);
        _argv_.push(inArray[2]);
        this.rsp = new hub_call_gate_reg_hub_direct_rsp(this.current_ch, _cb_uuid);
    ...
    public cb_tick_hub_health : (tick_time:number)=>void | null;
    tick_hub_health(inArray:any[]){
        let _argv_:any[] = [];
        _argv_.push(inArray[0]);
        if (this.cb_tick_hub_health){
            this.cb_tick_hub_health.apply(null, _argv_);
        }
    }

    public cb_reverse_reg_client_hub : (client_uuid:string)=>void | null;
    reverse_reg_client_hub(inArray:any[]){
        let _cb_uuid = inArray[0];
        let _argv_:any[] = [];
        _argv_.push(inArray[1]);
