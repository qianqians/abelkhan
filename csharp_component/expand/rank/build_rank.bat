cd ../../../rpc
python genc2h.py ../csharp_component/expand/rank/cli csharp ../csharp_component/expand/rank_client ../csharp_component/expand/rank ../csharp_component/expand/rank/comm
