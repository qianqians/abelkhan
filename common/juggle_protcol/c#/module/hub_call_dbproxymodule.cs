...
namespace module
{
    public class hub_call_dbproxy : juggle.Imodule 
    {
        ...
        public delegate void create_persisted_objecthandle(String argv0, String argv1);
        ...
        public delegate void updata_persisted_objecthandle(String argv0, String argv1, String argv2);
        ...
        public delegate void get_object_infohandle(String argv0, String argv1);
