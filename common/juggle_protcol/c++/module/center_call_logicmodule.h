...
public:
    center_call_logic(){
        ...
        protcolcall_set.insert(std::make_pair("distribute_server_address", boost::bind(&center_call_logic::distribute_server_address, this, _1)));
    ...
    void distribute_server_address(boost::shared_ptr<std::vector<boost::any> > _event){
