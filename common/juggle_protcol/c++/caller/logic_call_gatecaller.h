...
public:
    ...
    void forward_logic_call_client(std::string argv0,std::string argv1,std::string argv2,boost::shared_ptr<std::vector<boost::any> > argv3){
        auto v = boost::make_shared<std::vector<boost::any> >();
        v->push_back("logic_call_gate");
    ...
    void forward_logic_call_group_client(boost::shared_ptr<std::vector<boost::any> > argv0,std::string argv1,std::string argv2,boost::shared_ptr<std::vector<boost::any> > argv3){
        auto v = boost::make_shared<std::vector<boost::any> >();
        v->push_back("logic_call_gate");
    ...
    void forward_logic_call_global_client(std::string argv0,std::string argv1,boost::shared_ptr<std::vector<boost::any> > argv2){
        auto v = boost::make_shared<std::vector<boost::any> >();
        v->push_back("logic_call_gate");
