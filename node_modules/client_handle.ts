...
export class imodule {
    ...
    public invoke(cb_name:string, _event:any) {
        this.methods.get(cb_name).apply(this, _event);
    }
}
...
export class modulemng {
    ...
    public reg_module(module_name:string, _module:imodule) {
...
export class client
{
    ...
    constructor() {
        ...
        setInterval(this.heartbeats, 5 * 1000);

        this._gate_call_client_module = new _client.gate_call_client_module(abelkhan._modulemng);
        this._gate_call_client_module.cb_ntf_cuuid = this.ntf_cuuid;
        this._gate_call_client_module.cb_call_client = this.gate_call_client;

        this._hub_call_client_module = new hub.hub_call_client_module(abelkhan._modulemng);
        this._hub_call_client_module.cb_call_client = this.hub_call_client;
    }
    ...
    private heartbeats(tick:number)
    {
        if (this._gateproxy)
        {
        ...
        for (var [key, value] of this._hubproxy_set)
        {
            value.heartbeats();
        }
    }
