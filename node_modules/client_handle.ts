...
export class client
{
    ...
    public onMigrateClientStart:()=>void = null;
    private migrate_client_start() {
        if (this.onMigrateClientStart != null) {
            this.onMigrateClientStart.call(null);
        }
    }

    public onMigrateClientDone:()=>void = null;
    private migrate_client_done() {
        if (this.onMigrateClientDone != null) {
            this.onMigrateClientDone.call(null);
        }
    }
